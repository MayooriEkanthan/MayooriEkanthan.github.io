          ...
          <div className="flex-1 space-y-6 text-center lg:text-left z-10 order-2 lg:order-1 mt-12 lg:mt-0">
            <div className="">
              ...
              <div className="mt-10 flex flex-wrap justify-center lg:justify-start gap-4">
                ...
                <a href="/projects/Mayoori_Ekanthan_CV.pdf" download="Mayoori_Ekanthan_CV.pdf" className="bg-white/10 hover:bg-white/20 border border-white/20 text-white font-semibold py-3 px-8 rounded-full transition-all flex items-center gap-2">
